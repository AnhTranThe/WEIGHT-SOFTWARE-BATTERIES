...
public class resize_function_1
{
    private List<_addInfo> _arr_control_storage;
    private bool showRowHeader = false;

    public resize_function_1(Form _form_)
    {
    ...
    public void _get_initial_size() //get initial size//
    {
        ...
        var _controls = get_all_controls(form);//call the enumerator
    ...
    public void _resize() //Set the resize
    {
        ...
        foreach (var _item in _arr_control_storage)
        {
            ...
            _fontsize = (float)(((_item._fontsize_ * _form_ratio_width) / 2.5) +
                ((_item._fontsize_ * _form_ratio_height) / 2.5));
